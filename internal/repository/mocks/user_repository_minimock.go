...
//go:generate minimock -i github.com/ArturSaga/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreateUser          func(ctx context.Context, userInfo *model.UserInfo) (i1 int64, err error)
	inspectFuncCreateUser   func(ctx context.Context, userInfo *model.UserInfo)
	...
	funcUpdateUser          func(ctx context.Context, userInfo *model.UpdateUserInfo) (e1 emptypb.Empty, err error)
	inspectFuncUpdateUser   func(ctx context.Context, userInfo *model.UpdateUserInfo)
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, userInfo *model.UserInfo) *mUserRepositoryMockCreateUser {
	...
	mmCreateUser.defaultExpectation.params = &UserRepositoryMockCreateUserParams{ctx, userInfo}
...
// ExpectUserInfoParam2 sets up expected param userInfo for UserRepository.CreateUser
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectUserInfoParam2(userInfo *model.UserInfo) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, userInfo *model.UserInfo)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, userInfo *model.UserInfo) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, userInfo *model.UserInfo) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateUserExpectation{
		...
		params: &UserRepositoryMockCreateUserParams{ctx, userInfo},
	}
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, userInfo *model.UserInfo) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateUserParams{ctx, userInfo}
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateUserParams{ctx, userInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userInfo != nil && !minimock.Equal(*mm_want_ptrs.userInfo, mm_got.userInfo) {
				mmCreateUser.t.Errorf("UserRepositoryMock.CreateUser got unexpected parameter userInfo, want: %#v, got: %#v%s\n", *mm_want_ptrs.userInfo, mm_got.userInfo, minimock.Diff(*mm_want_ptrs.userInfo, mm_got.userInfo))
			}
	...
	mmCreateUser.t.Fatalf("Unexpected call to UserRepositoryMock.CreateUser. %v %v", ctx, userInfo)
	return
}
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Return(e1 emptypb.Empty, err error) *UserRepositoryMock {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserRepositoryMock.DeleteUser mock is already set by Set")
	}
	...
	mmDeleteUser.defaultExpectation.results = &UserRepositoryMockDeleteUserResults{e1, err}
	return mmDeleteUser.mock
}

// Set uses given function f to mock the UserRepository.DeleteUser method
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Set(f func(ctx context.Context, id int64) (e1 emptypb.Empty, err error)) *UserRepositoryMock {
	if mmDeleteUser.defaultExpectation != nil {
...
func (e *UserRepositoryMockDeleteUserExpectation) Then(e1 emptypb.Empty, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockDeleteUserResults{e1, err}
	return e.mock
}
...
func (mmDeleteUser *UserRepositoryMock) DeleteUser(ctx context.Context, id int64) (e1 emptypb.Empty, err error) {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Expect(ctx context.Context, userInfo *model.UpdateUserInfo) *mUserRepositoryMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserRepositoryMockUpdateUserParams{ctx, userInfo}
...
// ExpectUserInfoParam2 sets up expected param userInfo for UserRepository.UpdateUser
func (mmUpdateUser *mUserRepositoryMockUpdateUser) ExpectUserInfoParam2(userInfo *model.UpdateUserInfo) *mUserRepositoryMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Inspect(f func(ctx context.Context, userInfo *model.UpdateUserInfo)) *mUserRepositoryMockUpdateUser {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Return(e1 emptypb.Empty, err error) *UserRepositoryMock {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	mmUpdateUser.defaultExpectation.results = &UserRepositoryMockUpdateUserResults{e1, err}
	return mmUpdateUser.mock
}

// Set uses given function f to mock the UserRepository.UpdateUser method
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Set(f func(ctx context.Context, userInfo *model.UpdateUserInfo) (e1 emptypb.Empty, err error)) *UserRepositoryMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserRepositoryMockUpdateUser) When(ctx context.Context, userInfo *model.UpdateUserInfo) *UserRepositoryMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateUserExpectation{
		...
		params: &UserRepositoryMockUpdateUserParams{ctx, userInfo},
	}
...
func (e *UserRepositoryMockUpdateUserExpectation) Then(e1 emptypb.Empty, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockUpdateUserResults{e1, err}
	return e.mock
}
...
func (mmUpdateUser *UserRepositoryMock) UpdateUser(ctx context.Context, userInfo *model.UpdateUserInfo) (e1 emptypb.Empty, err error) {
	...
	mm_params := UserRepositoryMockUpdateUserParams{ctx, userInfo}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateUserParams{ctx, userInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userInfo != nil && !minimock.Equal(*mm_want_ptrs.userInfo, mm_got.userInfo) {
				mmUpdateUser.t.Errorf("UserRepositoryMock.UpdateUser got unexpected parameter userInfo, want: %#v, got: %#v%s\n", *mm_want_ptrs.userInfo, mm_got.userInfo, minimock.Diff(*mm_want_ptrs.userInfo, mm_got.userInfo))
			}
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserRepositoryMock.UpdateUser. %v %v", ctx, userInfo)
	return
}
